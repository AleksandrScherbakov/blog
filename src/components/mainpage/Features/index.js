        ...
        <div className={'features'}>
            <ul className={'features__container'}>
                <li className={'features__container__item'}>
                    <Link to={'/browse/App%20Design'} className={'features__container__item__icon features__container__item__icon--app'}>
                    ...
                    <h3>
                        <Link to={'/browse/App%20Design'}>App Design</Link>
                    </h3>
                    <p>
                ...
                <li className={'features__container__item'}>
                    <Link to={'/browse/Web%20Design'} className={'features__container__item__icon  features__container__item__icon--design'}>
                    ...
                    <h3>
                        <Link to={'/browse/Web%20Design'}>Web Design</Link>
                    </h3>
                    <p>
                ...
                <li className={'features__container__item'}>
                    <Link to={'/browse/Web%20Development'} className={'features__container__item__icon features__container__item__icon--development'}>
                    ...
                    <h3>
                        <Link to={'/browse/Web%20Development'}>Web Development</Link>
                    </h3>
                    <p>
                ...
                <li className={'features__container__item'}>
                    <Link to={'/browse/Brand%20Promotion'} className={'features__container__item__icon features__container__item__icon--promotion'}>
                    ...
                    <h3>
                        <Link to={'/browse/Brand%20Promotion'}>Brand promotion</Link>
                    </h3>
                    <p>
